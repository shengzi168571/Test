...
for j in range(len(tupleA)):    # 索引
    print(tupleA[j])

print("tupleA third: {}".format(tupleA[0:3]))      # 切片
print("tupleA's reverse: {}".format(tupleA[::-1]))  # 倒序打印
print("tupleA's odd number's index: {}".format(tupleA[-1]))  # 打印最后一个元素
print("old index and orr index: {}".format(tupleA[0:-1]))
