# 思考题
# 有这样一个句子"this is my house",该句子进行反转,输出为"house my is this"
sentence = "this is my hoouse"
new_sentence = ''
...
sentence = 'could1908 is good class'
...
print('please inout check code: {}'.format(code[0:4]))
