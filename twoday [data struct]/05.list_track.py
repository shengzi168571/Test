...
print("listB element: {}".format(listB))

listB.insert(2, "insert")   # 在指定位置插入元素：确定两元素,插入时使用右边元素引导,即可插入到两元素之间;
print("listB element: {}".format(listB))
...
print("listD element: {}".format(listD))

# 查询元素
listE = [1, 2, 3, 4, True, False, 'syring']
...
findex,index = 0, len(listI) - 1
while index - findex >= 0:
    middle = (findex + index) // 2
